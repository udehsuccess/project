    ...
    <div class="container">
        ...
        <div class="fund">
            ...
            <form action="" method="POST">
                ...
                <input type="hidden" name="fund_code" value="<?php echo $fund_code; ?>" />

                <div class="user-box plan" id="plans">
                    <label class="col" for="plan_selected">Select Plan: </label>
                    <select name="plan_selected" class="form-control" required>
                        <option value="" selected>Please Select Plan</option>
                        <option value="mini">$50 - $999</option>
                        <option value="standard">$1000 - $1999</option>
                        <option value="premium">$2000 - $4999</option>
                        <option value="vip">$5000 - $9999</option>
                        <option value="elite">$10000 - $500000</option>
                    </select>
                </div>
                ...
                <div class="user-box" id="user">
                    ...
                    <input type="text" class="form-control" name="username" readonly placeholder="Enter Amount" value=""
                        min="500" required>
                </div>
                ...
                <div class="user-box" id="address">
                    <label class="col">Senders Wallet Address: </label>
                    <input type="text" class="form-control" name="bitAddress" placeholder="Enter Your Wallet Address">
                </div>

                <div class="user-box" id="hush">
                    <label class="col">Transaction HASH ID: </label>
                    <input type="text" class="form-control" name="bitHash" required placeholder="Bitcoin ID:">
                </div>
                ...
                <div class="user-box" id="button">
                    <button name="submitBitcoinDetails" class="submit">Fund My Account</button>
                </div>
            </form>
        </div>
